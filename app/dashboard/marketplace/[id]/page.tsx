      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-slate-300 mt-4 leading-relaxed">{listing.description}</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="p-6 bg-slate-900 rounded-2xl border border-slate-800 shadow-xl">
            ...
            <Button className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-bold h-12 shadow-lg shadow-cyan-900/20 mb-4">
              Initiate Trade
            </Button>
