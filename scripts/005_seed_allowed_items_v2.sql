-- Seed allowed items from CSV (Arc Raiders items)
...
('Battery', 'Uncommon', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/e/e6/Battery.png'),
('Berries', 'Common', 'Nature', 'https://static.wikia.nocookie.net/arc-raiders/images/3/38/Berries.png'),
('Binoculars', 'Uncommon', 'Trinket', 'https://static.wikia.nocookie.net/arc-raiders/images/6/6f/Binoculars.png'),
('Bling', 'Rare', 'Misc', 'https://static.wikia.nocookie.net/arc-raiders/images/5/52/Bling.png'),
('Book', 'Common', 'Trinket', 'https://static.wikia.nocookie.net/arc-raiders/images/0/07/Book.png'),
('Boots', 'Common', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/7/78/Boots.png'),
('Bottle', 'Common', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/a/a5/Bottle.png'),
('Broken Glass', 'Common', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/7/70/Broken_Glass.png'),
('Calculator', 'Uncommon', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/1/1e/Calculator.png'),
('Camera', 'Rare', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/5/53/Camera.png'),
('Can', 'Common', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/c/c3/Can.png'),
('Candy Bar', 'Common', 'Quick Use', 'https://static.wikia.nocookie.net/arc-raiders/images/4/43/Candy_Bar.png'),
('Canteen', 'Common', 'Trinket', 'https://static.wikia.nocookie.net/arc-raiders/images/3/3c/Canteen.png'),
('Carbon Fiber', 'Epic', 'Refined Material', 'https://static.wikia.nocookie.net/arc-raiders/images/4/49/Carbon_Fiber.png'),
('Cardboard', 'Common', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/4/47/Cardboard.png'),
('Cassette Tape', 'Uncommon', 'Trinket', 'https://static.wikia.nocookie.net/arc-raiders/images/d/d2/Cassette_Tape.png'),
('Ceramic', 'Uncommon', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/9/98/Ceramic.png'),
('Charred Wood', 'Common', 'Recyclable', 'https://static.wikia.nocookie.net/arc-raiders/images/d/da/Charred_Wood.png'),
('Chicken', 'Uncommon', 'Quick Use', 'https://static.wikia.nocookie.net/arc-raiders/images/0/0c/Chicken.png'),
('Chips', 'Common', 'Quick Use', 'https://static.wikia.nocookie.net/arc-raiders/images/7/7f/Chips.png')
